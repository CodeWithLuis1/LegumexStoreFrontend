...
type CreateAddinFormProps = {
    register: UseFormRegister<CreateAddinInput>
    errors: FieldErrors<CreateAddinInput>
}

export function CreateAddinForm({ register, errors }: CreateAddinFormProps) {
