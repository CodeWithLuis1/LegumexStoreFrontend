...
type CreateIngredientFormProps = {
    register: UseFormRegister<CreateIngredientInput>
    errors: FieldErrors<CreateIngredientInput>
}

export function CreateIngredientForm({ register, errors }: CreateIngredientFormProps) {
